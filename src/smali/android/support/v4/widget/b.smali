...
# instance fields
.field private final d:Landroid/support/v4/widget/b$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/b;->a:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/support/v4/view/b/a;

    invoke-direct {v0}, Landroid/support/v4/view/b/a;-><init>()V

    sput-object v0, Landroid/support/v4/widget/b;->b:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, Landroid/support/v4/widget/b;->c:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/b/h;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p1, p0, Landroid/support/v4/widget/b;->f:Landroid/content/res/Resources;

    new-instance p1, Landroid/support/v4/widget/b$a;

    invoke-direct {p1}, Landroid/support/v4/widget/b$a;-><init>()V

    iput-object p1, p0, Landroid/support/v4/widget/b;->d:Landroid/support/v4/widget/b$a;

    iget-object p1, p0, Landroid/support/v4/widget/b;->d:Landroid/support/v4/widget/b$a;

    sget-object v0, Landroid/support/v4/widget/b;->c:[I
...
.method static synthetic a(Landroid/support/v4/widget/b;F)F
    .locals 0

    iput p1, p0, Landroid/support/v4/widget/b;->h:F
...
.method private a()V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/b;->d:Landroid/support/v4/widget/b$a;
    ...
    sget-object v2, Landroid/support/v4/widget/b;->a:Landroid/view/animation/Interpolator;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/b;->g:Landroid/animation/Animator;
...
.method private a(FFFF)V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/b;->f:Landroid/content/res/Resources;
...
.method private a(FLandroid/support/v4/widget/b$a;)V
    .locals 2
...
.method private a(FLandroid/support/v4/widget/b$a;Z)V
    .locals 7

    iget-boolean v0, p0, Landroid/support/v4/widget/b;->i:Z
    ...
    sget-object v4, Landroid/support/v4/widget/b;->b:Landroid/view/animation/Interpolator;
    ...
    sget-object v5, Landroid/support/v4/widget/b;->b:Landroid/view/animation/Interpolator;
    ...
    iget v2, p0, Landroid/support/v4/widget/b;->h:F
    ...
    invoke-virtual {p2, v3}, Landroid/support/v4/widget/b$a;->c(F)V

    invoke-virtual {p2, p3}, Landroid/support/v4/widget/b$a;->d(F)V

    invoke-direct {p0, p1}, Landroid/support/v4/widget/b;->d(F)V
...
.method static synthetic a(Landroid/support/v4/widget/b;FLandroid/support/v4/widget/b$a;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/b;->a(FLandroid/support/v4/widget/b$a;)V

    return-void
.end method

.method static synthetic a(Landroid/support/v4/widget/b;FLandroid/support/v4/widget/b$a;Z)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroid/support/v4/widget/b;->a(FLandroid/support/v4/widget/b$a;Z)V

    return-void
.end method

.method static synthetic a(Landroid/support/v4/widget/b;)Z
    .locals 0

    iget-boolean p0, p0, Landroid/support/v4/widget/b;->i:Z

    return p0
.end method

.method static synthetic a(Landroid/support/v4/widget/b;Z)Z
    .locals 0

    iput-boolean p1, p0, Landroid/support/v4/widget/b;->i:Z

    return p1
.end method

.method static synthetic b(Landroid/support/v4/widget/b;)F
    .locals 0

    iget p0, p0, Landroid/support/v4/widget/b;->h:F
...
.method private d(F)V
    ...
    iput p1, p0, Landroid/support/v4/widget/b;->e:F
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Landroid/support/v4/widget/b;->e:F
    ...
    iget-object v1, p0, Landroid/support/v4/widget/b;->d:Landroid/support/v4/widget/b$a;
...
.method public isRunning()Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/b;->g:Landroid/animation/Animator;
...
.method public start()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/b;->i:Z
