...
# interfaces
.implements Landroid/support/v4/app/i$f;
...
.method public constructor <init>(Landroid/support/v4/app/i;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Landroid/support/v4/app/a;->b:Landroid/support/v4/app/i;
...
.method private a(ILandroid/support/v4/app/Fragment;Ljava/lang/String;I)V
    ...
    iput-object v0, p2, Landroid/support/v4/app/Fragment;->r:Landroid/support/v4/app/i;
    ...
    iget p3, p2, Landroid/support/v4/app/Fragment;->w:I
    ...
    iget p2, p2, Landroid/support/v4/app/Fragment;->w:I
...
.method a(Z)I
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/i;->a(Landroid/support/v4/app/a;)I
    ...
    invoke-virtual {v0, p0, p1}, Landroid/support/v4/app/i;->a(Landroid/support/v4/app/i$f;Z)V
...
.method a(Ljava/util/ArrayList;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    iget v7, v3, Landroid/support/v4/app/Fragment;->x:I
    ...
    iget-object v9, p0, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iget-object v12, p0, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iget-object p2, p0, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
...
.method public a()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/a;->v:Ljava/util/ArrayList;
...
.method a(I)V
    ...
    iget v2, v2, Landroid/support/v4/app/Fragment;->q:I
...
.method public a(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
    ...
    iget-object v0, p0, Landroid/support/v4/app/a;->l:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroid/support/v4/app/a;->p:Ljava/lang/CharSequence;
...
.method a(Ljava/util/ArrayList;II)Z
    ...
    iget-object v4, p0, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iget v4, v4, Landroid/support/v4/app/Fragment;->x:I
    ...
    iget-object v6, v5, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iget-object v8, v5, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
...
.method public a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    iget-boolean p1, p0, Landroid/support/v4/app/a;->j:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Landroid/support/v4/app/a;->b:Landroid/support/v4/app/i;

    invoke-virtual {p1, p0}, Landroid/support/v4/app/i;->b(Landroid/support/v4/app/a;)V
...
.method b(Z)V
    ...
    iget v4, p0, Landroid/support/v4/app/a;->h:I

    invoke-static {v4}, Landroid/support/v4/app/i;->d(I)I

    move-result v4

    iget v5, p0, Landroid/support/v4/app/a;->i:I
    ...
    :pswitch_0
    iget-object v4, p0, Landroid/support/v4/app/a;->b:Landroid/support/v4/app/i;
    ...
    :goto_1
    iget-boolean v4, p0, Landroid/support/v4/app/a;->u:Z
    ...
    iget-object v2, p0, Landroid/support/v4/app/a;->b:Landroid/support/v4/app/i;
...
.method c()V
    ...
    iget v7, p0, Landroid/support/v4/app/a;->i:I
    ...
    :pswitch_0
    iget-object v6, p0, Landroid/support/v4/app/a;->b:Landroid/support/v4/app/i;
    ...
    :goto_1
    iget-boolean v6, p0, Landroid/support/v4/app/a;->u:Z
    ...
    iget-object v3, p0, Landroid/support/v4/app/a;->b:Landroid/support/v4/app/i;
...
.method public toString()Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/app/a;->l:Ljava/lang/String;
