...
.method public constructor <init>(Landroid/support/v4/app/a;)V
    ...
    iget-object v0, p1, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iget-boolean v1, p1, Landroid/support/v4/app/a;->j:Z
    ...
    iget-object v3, p1, Landroid/support/v4/app/a;->c:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Landroid/support/v4/app/a;->l:Ljava/lang/String;
    ...
    iget-object v0, p1, Landroid/support/v4/app/a;->p:Ljava/lang/CharSequence;
    ...
    iget-boolean p1, p1, Landroid/support/v4/app/a;->u:Z
...
# virtual methods
.method public a(Landroid/support/v4/app/i;)Landroid/support/v4/app/a;
    .locals 7

    new-instance v0, Landroid/support/v4/app/a;

    invoke-direct {v0, p1}, Landroid/support/v4/app/a;-><init>(Landroid/support/v4/app/i;)V
    ...
    iput v4, v3, Landroid/support/v4/app/a$a;->c:I

    add-int/lit8 v4, v5, 0x1

    aget v5, v1, v5

    iput v5, v3, Landroid/support/v4/app/a$a;->d:I

    add-int/lit8 v5, v4, 0x1

    aget v4, v1, v4

    iput v4, v3, Landroid/support/v4/app/a$a;->e:I
    ...
    iput v1, v0, Landroid/support/v4/app/a;->g:I
    ...
    iput p1, v0, Landroid/support/v4/app/a;->i:I

    iget-object p1, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object p1, v0, Landroid/support/v4/app/a;->l:Ljava/lang/String;

    iget p1, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput p1, v0, Landroid/support/v4/app/a;->n:I

    const/4 p1, 0x1

    iput-boolean p1, v0, Landroid/support/v4/app/a;->j:Z

    iget v1, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v1, v0, Landroid/support/v4/app/a;->o:I

    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/a;->p:Ljava/lang/CharSequence;

    iget v1, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v1, v0, Landroid/support/v4/app/a;->q:I

    iget-object v1, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v1, v0, Landroid/support/v4/app/a;->r:Ljava/lang/CharSequence;
    ...
    iput-object v1, v0, Landroid/support/v4/app/a;->t:Ljava/util/ArrayList;

    iget-boolean v1, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v1, v0, Landroid/support/v4/app/a;->u:Z
